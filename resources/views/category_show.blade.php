...
<link rel="stylesheet" href="{{asset('jq/css/feature-carousel.css')}}" charset="utf-8" />
    ...
    <script src="{{asset('jq/js/jquery.featureCarousel.min.js')}}" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
  body,html{
    /*height:100%;*/
  }
...
<div class="container">
    <div class='row' style="margin-top: 150px;height: 500px;">
        <div class='col-md-12'>
    ...
    <div class="carousel-container">
      ...
      @if(!$players->count())
        <div class="alert alert-warning">
            <p>No players in selected category</p>
        </div>
      @endif
